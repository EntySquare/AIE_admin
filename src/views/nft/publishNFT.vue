<template>
  <div class="container">
    <a-card>
      <a-typography>
        <a-typography-title :heading="6"> 发布NFT </a-typography-title>
      </a-typography>
      <a-divider />
      <a-grid :cols="24" :col-gap="16" :row-gap="16" style="margin-top: 16px">
        ...
        >
          <a-typography-title :heading="6"> NFT主图 </a-typography-title>
          <a-upload
          ...
          <a-space direction="vertical" :size="16" style="display: block">
            ...
            <a-row>
              ...
              <a-col :span="5">
                <div>
                  <a-button type="text" @click="openUserSelector"
                    >aaaaaa</a-button
                  >
                </div>
              </a-col>
            ...
            <a-row>
              <a-col :span="18">
                <div style="line-height: 33px" @click="openUserSelector"
                  >作者账号</div
                >
              </a-col>
              <a-col :span="5">
            ...
            <a-divider />
            <a-typography-title :heading="6"> 作品简介 </a-typography-title>
            <a-textarea
              placeholder="请输入内容"
              allow-clear
        ...
        >
          <a-col>
            <a-typography-title :heading="6"> 售价(元) </a-typography-title>
